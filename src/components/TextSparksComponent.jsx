...
//     <div>
//       <ul data-time="3000">
//         <li data-hue="197" className="hidden">
//           D
//         </li>
//         <li data-hue="0" className="hidden">
//           E
//         </li>
//         <li data-hue="197" className="hidden">
//           V
//         </li>
//         <li data-hue="87" className="hidden">
//           H
//         </li>
//         <li data-hue="45" className="hidden">
//           A
//         </li>
//         <li data-hue="120" className="hidden">
//           B
//         </li>
//         <li data-hue="197" className="hidden">
//           I
...
//         </li>
//       </ul>
//       <canvas className="h-96 object-cover" ref={canvasRef}></canvas>
//     </div>
//   );
// };

// export default TextSparksComponent;
